...
- `data/` – Contains CSV files:
  ...
  - `10_project_data_annotations.csv`: Gene/transcript annotations (reuse from Exercise 1).
  - `10_project_data_signals.csv`: RNA binding protein signals (reuse from Exercise 1).
